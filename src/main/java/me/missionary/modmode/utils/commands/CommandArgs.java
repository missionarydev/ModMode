package me.missionary.modmode.utils.commands;
...
public class CommandArgs {
    ...
    protected CommandArgs(CommandSender sender, String usage, org.bukkit.command.Command command, String label, String[] args, int subCommand) {
